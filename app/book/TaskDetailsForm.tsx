...
const TaskDetailsForm = ({ onNext }: MultiStepFormProps) => {
  ...
  const videoInput = watch("videoInput");
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="space-y-4">
        ...
        <textarea
          className={cn(
            "w-full min-h-[160px] p-6 rounded-xl bg-[#EBEBEB] text-gray-800 placeholder:text-gray-400 border border-transparent focus:border-primary focus:ring-1 focus:ring-primary focus:bg-white outline-none transition-all resize-y text-base",
      ...
      <VideoUploadSection setValue={setValue} videoInput={videoInput} />
